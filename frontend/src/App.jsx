      ...
      <div style={{ flex: 1, position: 'relative', overflow: 'hidden' }}>
        ...
        {geoLoading && (
          <div style={{
            ...
            <div style={{ textAlign: 'center' }}>
              <div style={{
                width: 36, height: 36, border: '3px solid #2e3348',
                borderTop: '3px solid #6c7dff', borderRadius: '50%',
        ...
        {geoError && !geoLoading && (
          <div style={{
            ...
            <div style={{
              background: '#21253a', border: '1px solid #ef444444',
              borderRadius: 12, padding: '24px 32px', textAlign: 'center', maxWidth: 360,
            }}>
              ...
              <code style={{
                display: 'block', background: '#1a1d27', borderRadius: 6,
                padding: '8px 12px', fontSize: 11, color: '#6c7dff',
              }}>
