...
const StatCard = ({ label, value, sub }) => (
  ...
  >
    <p style={{ fontSize: 10, color: '#555e80', textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 4 }}>
      {label}
    </p>
...
export default function StatsPanel({ indicator, stats }) {
  if (!stats) {
    return <div style={{ padding: 16, color: '#555e80', fontSize: 12, textAlign: 'center' }}>Chargement des stats...</div>
  }
